...
function validarPersonaje(personaje, full) {
    ...
    if (full) {
        if (personaje.hasOwnProperty('id') && personaje.hasOwnProperty('nombre') && personaje.hasOwnProperty('apellido') && personaje.hasOwnProperty('edad') && personaje.hasOwnProperty('casa') && personaje.hasOwnProperty('traidor')) {
            esValida = true;
        }
    } else {
        if (personaje.hasOwnProperty('nombre') && personaje.hasOwnProperty('apellido') && personaje.hasOwnProperty('edad') && personaje.hasOwnProperty('casa') && personaje.hasOwnProperty('traidor')) {
            esValida = true;
        }
